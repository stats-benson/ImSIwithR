#' Walkerdisc Dataset
#'
#' Dataset combining 14 different clinical trials (randomly selecting individuals) to attempt to answer the question of the cardiovascular and brain health benefits of fish oil. Participants were given set doses of omega-3 fatty acids, taken daily, then omega-3 levels were recorded.
#'
#' @format A data frame with 1208 rows and 11 variables:
#' \describe{
