...
#'
#'
#' @format A data frame with 533 rows and 9 variables:
#' \describe{
...
#'   \item{H2O_Source.x}{Where water is usually obtained from for the household. ("Bore Hole" or "Catchment" or "River/Creek" or "Tap(Treated)" or "Tap(Untreated)" or "Well")
